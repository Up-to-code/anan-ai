# RED (Real Estate Developer) Zone

## The Fortress Pattern

This folder is strictly an isolated **Fortress** assigned to developers managing portfolios.
...
2. **Error Isolation:** If modifying top-level layouts, ensure you do not break the `RedZoneErrorBoundary` wrapping `App.tsx`.
3. **Strict API Location:** All new data-fetching hooks MUST reside in the `api/` directory.
