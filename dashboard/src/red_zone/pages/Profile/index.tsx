...
import { LogOut as LogOutIcon, User as UserIcon, Mail as MailIcon, Shield as ShieldIcon, ChevronLeft as ChevronLeftIcon } from "lucide-react";
import { Link } from "react-router-dom";

/**
 * WHY:   Allows developers to view their account details and authentication state.
  ...
  return (
    <div className="max-w-2xl space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">عرض وإدارة بيانات حسابك كمطور عقاري</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-none">
        <div className="p-8 border-b border-slate-100 bg-slate-50/50 flex flex-col items-center text-center">
          ...
          <h2 className="mt-4 text-xl font-bold text-slate-900">{user?.name ?? "مطوّر عقاري"}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-4 p-4 rounded-xl border border-slate-100 hover:border-blue-100 transition-colors">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-slate-900 mt-0.5">مطوّر عقاري (RED)</p>
              </div>
            </div>
          </div>
