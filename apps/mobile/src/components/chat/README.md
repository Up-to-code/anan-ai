...
Shared UI building blocks for the buyer assistant experience.

- `AssistantPresenceStrip.tsx` renders the top assistant header and search shortcut.
...
- Timeline and composer ownership now live in `src/features/BuyerAssistantHomeScreen/` through the Gifted Chat host and feature-owned composer.
