...
export function CodeSnippetClient({
  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-xl border border-slate-800 bg-[#0d1117] text-slate-50 shadow-sm [&_pre]:bg-transparent [&_pre]:m-0 [&_pre]:p-4 [&_code]:text-[13px] [&_code]:leading-6 [&_code]:font-mono">
