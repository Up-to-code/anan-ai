...
const emptyVerificationFixture = {
  detail: {
    identity: {
      userKey: "auth__u-1",
      name: "Nada",
...
it("renders empty-state copy when related panels have no data", async () => {
  getAdminUserDetailPageData.mockResolvedValue(emptyVerificationFixture);
...
it("renders offer and access metrics from the expanded detail payload", async () => {
  getAdminUserDetailPageData.mockResolvedValue(expandedMetricsFixture);
