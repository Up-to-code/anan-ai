    ...
    <div className="flex flex-col gap-8">
      <div className="border border-slate-200 bg-white p-8">
        <div className="mb-6 flex flex-row-reverse items-center justify-between border-b border-slate-100 pb-4">
          ...
          <span className="bg-slate-50 px-2 py-1 text-[10px] font-black tracking-widest text-slate-400">{formState.images.length}/10</span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {formState.images.map((img, idx) => (
            <div key={idx} className="group relative aspect-square overflow-hidden border-2 border-slate-100 bg-white">
          ...
          <div
            className={cn(
              "group mt-2 col-span-2 flex cursor-pointer flex-row-reverse items-center justify-between border-2 p-4 text-right transition-all",
              formState.video
        ...
        <div className="grid gap-6">
          ...
          <div className="grid gap-3 border border-slate-200 bg-slate-50/60 p-4 text-right">
            <div className="flex items-center justify-between">
              ...
              <span className={`rounded-none border px-3 py-1 text-[10px] font-black ${adLicenseTone}`}>{adLicenseLabel}</span>
            </div>
            <input
              type="text"
