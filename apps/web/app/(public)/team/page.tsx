  ...
  return (
    <div className="p-12 border-2 border-slate-100 space-y-8 bg-white hover:border-blue-600 transition-all group">
      <div className="h-20 w-20 bg-slate-50 flex items-center justify-center group-hover:bg-blue-600 transition-colors">
        <Icon className="h-10 w-10 text-slate-300 group-hover:text-white" />
      </div>
      <div className="space-y-4">
        <h3 className="text-2xl font-black text-slate-900 uppercase">{props.title}</h3>
        <span className="block text-[10px] font-black text-blue-600 uppercase tracking-[0.2em]">{props.subtitle}</span>
        <p className="text-slate-500 font-bold leading-relaxed">{props.description}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <Section className="py-24 border-t border-slate-100 text-center">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <p className="font-bold text-slate-500 text-xl leading-relaxed">
