...
export default function EndpointCard({ endpoint }: { endpoint: DocsEndpoint }) {
  return (
    <div className="flex flex-col overflow-hidden rounded-lg border-2 border-slate-900 bg-white">
      <div className="flex flex-col gap-4 border-b-2 border-slate-100 p-8">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <code className="rounded-lg border-2 border-slate-100 bg-slate-100 px-3 py-1.5 text-xs font-black text-slate-900">{endpoint.path}</code>
        </div>
        <div>
