      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-3 lg:px-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <Link href="/" className="text-xs font-black uppercase tracking-[0.2em] text-slate-900 transition-colors hover:text-blue-600 dark:text-slate-100 dark:hover:text-blue-400">
              Anan Docs
            </Link>
        ...
        <nav className="flex items-center gap-3">
          ...
          <Button variant="ghost" size="sm" className="hidden rounded-lg px-3 text-xs font-black uppercase tracking-widest text-slate-600 hover:bg-slate-50 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-100 md:flex" render={<Link href="/docs/getting-started" />}>
            Quickstart
          </Button>
          <Button size="sm" className="rounded-lg bg-blue-600 px-6 py-4 text-xs font-black uppercase tracking-widest text-white shadow-none transition-colors hover:bg-blue-700" render={<Link href="/docs/oauth/authorization-code-pkce" />}>
            OAuth Flow
          </Button>
        </nav>
      </div>
