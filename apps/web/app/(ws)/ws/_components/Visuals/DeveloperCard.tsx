    ...
    >
      <div className="flex items-start gap-4 p-5">
        ...
        <div className="relative shrink-0">
          ...
          <span className="absolute bottom-0 right-0 flex h-5 w-5 items-center justify-center rounded-full border-2 border-white bg-indigo-500 text-white">
      ...
      <div className="flex items-center justify-between border-t border-slate-100 bg-slate-50/50 px-5 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-bold text-indigo-700">مطور عقاري</span>
        </div>
