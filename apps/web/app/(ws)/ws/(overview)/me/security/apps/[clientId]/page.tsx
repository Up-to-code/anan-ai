  ...
  return (
    <div className="flex flex-col">
      <div className="border-b-2 border-slate-100 px-6 pt-6 lg:px-10 lg:pt-10">
        <div className="mb-4">
          <Link href={buildWorkspaceSecurityAppsPath()} className="inline-flex items-center gap-1 text-xs font-black uppercase tracking-widest text-slate-500 hover:text-blue-600">
      ...
      <div className="p-6 lg:p-10">
        <WorkspacePanel>
          <div className="space-y-6">
            ...
            {app.offlineAccess ? <div className="border-2 border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">هذا التطبيق يمتلك صلاحية اتصال ممتدة. عند الإلغاء سيتم قطع كل الجلسات.</div> : null}
