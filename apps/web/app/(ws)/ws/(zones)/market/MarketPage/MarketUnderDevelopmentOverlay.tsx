...
export default function MarketUnderDevelopmentOverlay({
  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-4xl rounded-xl border border-amber-200 bg-white/95 p-5 shadow-xl backdrop-blur-sm md:p-6">
        <div className="grid gap-4 md:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-5 text-right">
            <div className="text-sm font-semibold text-amber-900">Market marker</div>
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-5 text-right">
            <div className="text-sm font-semibold text-slate-950">الصفحة الحالية</div>
            <div className="mt-2 text-sm text-slate-600">{pageTitle}</div>
            <div className="mt-4 text-sm font-semibold text-slate-950">جاهز لاحقاً</div>
