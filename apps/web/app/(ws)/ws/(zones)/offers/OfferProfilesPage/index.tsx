    ...
    <div className="flex min-h-full flex-col pb-24">
      <div className="grid gap-6 px-6 py-6 lg:px-8 lg:py-8">
        <section className="border border-slate-200 bg-white p-6 text-right">
          ...
          <div className="mt-4 text-xs font-black tracking-[0.18em] text-slate-400">{totalItems} ملف ظاهر في هذه الصفحة</div>
        </section>
            ...
            <article key={profile.id} className="border border-slate-200 bg-white p-5">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs font-bold text-slate-500">{profile.kind === "broker" ? "ملف وسيط" : "ملف مطور"}</p>
                </div>
                <div className="border border-slate-200 bg-slate-50 px-3 py-1 text-[10px] font-black tracking-[0.18em] text-slate-600">{profile.offerCount} عروض</div>
              </div>
