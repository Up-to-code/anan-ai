...
/**
 * WHY:   The client web app needs the same Cairo and mono font coverage as the main web surface.
 * WHAT:  Injects the extended font-face declarations required for bilingual rendering.
 * HOW:   Reuses the existing public font files and exposes them to the root layout.
 */
