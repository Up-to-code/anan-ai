...
function DocsPagination({ page }: { page: DocsPageDefinition }) {
  ...
  return (
    <div className="mt-12 grid gap-px border-t-2 border-slate-100 bg-slate-100 pt-8 dark:border-slate-800 dark:bg-slate-900 sm:grid-cols-2">
      {previousPage ? (
        <Link href={withLocale(locale, previousPage.href)} className="group flex flex-col items-start justify-center border-r-2 border-transparent bg-white p-8 transition-colors hover:border-blue-600 hover:bg-slate-50 dark:bg-slate-950 dark:hover:bg-slate-900 sm:border-slate-100 sm:hover:border-blue-600 dark:sm:border-slate-800">
      ...
      {nextPage ? (
        <Link href={withLocale(locale, nextPage.href)} className="group flex flex-col items-end justify-center border-l-2 border-transparent bg-white p-8 text-right transition-colors hover:border-blue-600 hover:bg-slate-50 dark:bg-slate-950 dark:hover:bg-slate-900 sm:border-slate-100 sm:hover:border-blue-600 dark:sm:border-slate-800">
