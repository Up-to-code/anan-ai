...
const PRIVATE_PUBLIC_PATTERNS = [
  {
    group: ["@/app/[locale]/(public)/_components/*"],
    message:
      "Public-zone internals are private. Use '@/app/[locale]/(public)/public' or local relative imports inside the public zone.",
  },
  {
    group: ["@/app/[locale]/(public)/docs/_components/*"],
    message:
      "Docs internals are private. Use '@/app/[locale]/(public)/docs/public' or local relative imports inside the docs zone.",
  },
  {
    group: ["@/app/[locale]/(public)/signin/_components/*"],
    message:
