...
#### **Output Formats**
- **text:** 可读的设计文档，适合直接阅读 (Readable design documents, suitable for direct reading)
- **jsonl:** 结构化输出，适合后续处理或存档 (Structured output, suitable for further processing or archiving)
