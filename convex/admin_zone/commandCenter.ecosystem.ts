...
/**
 * WHY:   The admin team needs one ecosystem-health dataset to judge onboarding quality, verification progress, and subscription adoption.
 * WHAT:  Returns broker/developer totals, onboarding trend, verification mix, subscription status, action-mode adoption, and an organization leaderboard.
 ...
 */
export const ecosystemHealthAnalytics = query({
  args: {
