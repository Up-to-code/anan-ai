/**
 * getMemoryContext.ts — User memory context tool for recommender
 *
 * WHY:   Recommendations need user preferences and constraints.
...
export function getMemoryContext(ctx: ActionCtx, runtime: AgentRuntimeContext): Tool {
  return tool({
    description: "Fetch relevant user memory context for recommendations.",
