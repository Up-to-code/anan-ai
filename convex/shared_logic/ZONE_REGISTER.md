...
## Top-Level Ownership
- `agencies/`, `offers/`, `properties/`, `market/`, `users/`, `verifications/`, `subscriptions/`: reusable business capabilities
...
- owner zones (`broker_zone`, `red_zone`, `user_zone`, `admin_zone`, `public_zone`)
- web server repository adapters and admin/mobile flows
